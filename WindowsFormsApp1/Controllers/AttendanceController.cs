    ...
    internal class AttendanceController
    {
        ...
        public static bool AddAttendance(Attendance att)
        {
            try
            {
                ...
                {
                    string query = @"INSERT INTO Attendance (StudentID, SubjectID, Date, Status)
        ...
        // ✅ Get attendance for all students by subject + date
        ...
        // ✅ Get attendance by Student (for StudentDashboard or View)
        public static List<dynamic> GetAttendanceByStudent(int studentId)
        {
            ...
            {
                MessageBox.Show("Error fetching student attendance: " + ex.Message);
            }
